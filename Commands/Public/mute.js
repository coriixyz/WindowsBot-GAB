			...
			if(bot.isMuted(msg.channel, member)) {
				msg.channel.createMessage({
					embed: {
                        ...
                        color: 0xFF0000,
						description: `**@${bot.getName(msg.channel.guild, serverDocument, member)}** is already muted. 🤓`
					}
				});
			} else {
					...
					if(err) {
						...
						msg.channel.createMessage({
							embed: {
                                ...
                                color: 0xFF0000,
								description: `I couldn't mute **@${bot.getName(msg.channel.guild, serverDocument, member)}** in this channel 😴`,
								footer: {
